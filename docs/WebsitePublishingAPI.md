...
type PublicEvent = {
  ...
  description: string | null; // derived from `public.events.notes`; treat as plain text (should be written as public-safe copy)
