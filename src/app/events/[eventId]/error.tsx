  ...
  return (
    <div className="flex flex-1 items-center justify-center p-8">
      <div className="w-full max-w-md rounded-[var(--radius-lg)] border border-[var(--hair)] bg-[var(--paper)] p-8 text-center shadow-card">
        <p className="eyebrow mb-3">Event detail</p>
        <h2 className="font-brand-serif text-2xl font-medium text-[var(--navy)]">Could not load event</h2>
        <p className="mt-3 text-sm text-[var(--ink-muted)]">
          There was a problem loading this event. Please try again or go back to the events list.
        </p>
        {error.digest && (
